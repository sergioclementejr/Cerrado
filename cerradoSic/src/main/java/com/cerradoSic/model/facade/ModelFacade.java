...
public class ModelFacade {
	...
	private static Class<?>[] classes = { Aluno.class, Especialidade.class, Matricula.class, Mensalidade.class,
			Modalidade.class };
	...
	private ModelFacade() {
		...
		builder = new StandardServiceRegistryBuilder().applySettings(con.getProperties());
